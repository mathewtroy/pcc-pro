...
/**
 * Initializes the Longest Proper Prefix which is also Suffix (LPS) array for the Knuth-Morris-Pratt algorithm.
 *
...
/**
 * Computes the Longest Proper Prefix which is also Suffix (LPS) array for the Knuth-Morris-Pratt algorithm.
 *
 * @param pattern The pattern for which the LPS array is computed
 * @param M The length of the pattern
